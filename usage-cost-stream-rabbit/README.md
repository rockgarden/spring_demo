...
Visit the [Spring Initialzr site](https://start.spring.io/) and follow these instructions:
...
```
java -jar usage-detail-sender/target/usage-detail-sender-rabbit-0.0.1-SNAPSHOT.jar --server.port=9001
```
...
```
java -jar usage-cost-processor/target/usage-cost-processor-rabbit-0.0.1-SNAPSHOT.jar --server.port=9002
```
...
```
java -jar usage-cost-logger/target/usage-cost-logger-rabbit-0.0.1-SNAPSHOT.jar --server.port=9003
```
